...
class SingleStream(nn.Module):
    ...
    def __init__(self, num_classes=4, pretrained=True, use_rgb=True, use_depth=False):
        ...
        self.model = torchvision.models.segmentation.deeplabv3_resnet50(pretrained=False)
        if pretrained:
...
class SingleStreamResNet101(nn.Module):
    """ Constructs Resnet101-Deeplabv3 segmentation model with additional streams for depth inputs
    """
    def __init__(self, num_classes=4, pretrained=True, use_rgb=True, use_depth=False):
        """
        @param num_classes (int): Number of classes including background
